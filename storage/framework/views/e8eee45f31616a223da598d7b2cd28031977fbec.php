...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <?php endif; ?>
      <a href="<?php echo e(route('account.create')); ?>" class="btn btn-info" style="margin-bottom:5px">Tạo mới</a>
            ...
            <?php if( $items->count() > 0 ): ?>
              ...
              <?php foreach( $items as $item ): ?>
                ...
                <tr id="row-<?php echo e($item->id); ?>">
                  ...
                  <td><?php echo e($item->role == 1 ? "Editor"  : "Admin"); ?></td>
                  ...
                  <td style="white-space:nowrap">  
                    ...
                    <a href="<?php echo e(route( 'account.edit', [ 'id' => $item->id ])); ?>" class="btn-sm btn btn-primary">Chỉnh sửa</a>                 
                    
                    <a onclick="return callDelete('<?php echo e($item->name); ?>','<?php echo e(route( 'account.destroy', [ 'id' => $item->id ])); ?>');" class="btn-sm btn btn-danger">Xóa</a>
