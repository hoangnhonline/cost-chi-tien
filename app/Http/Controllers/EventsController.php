...
class EventsController extends Controller
{
    ...
    */
    ...
    public function ajaxSearch(Request $request){    
        ...
        return view('events.content-search', compact( 'items', 'arrSearch', 'loaiSpArr', 'cateArr'));
    }
    /**
    ...
    */
    public function edit($id)
    {
        ...
        return view('events.edit', compact( 'detail', 'meta'));
    }
    ...
    public function productEvent(Request $request)
    {
        ...
        $dataList = ProductEvent::where('event_id', $event_id)->where('product_event.status', 1)
                    ...
                    ->get();        
        return view('events.product-event', compact( 'detail', 'dataList'));
    }
