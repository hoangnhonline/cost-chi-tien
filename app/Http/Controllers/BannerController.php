...
class BannerController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
       ...
       // dd($items->count());die;
        return view('banner.index', compact( 'items', 'detail', 'arrSearch'));
    }
    ...
    */
    public function create(Request $request)
    {
        ...
        return view('banner.create', compact('object_id', 'object_type', 'detail'));
    }
    ...
    */
    public function edit(Request $request)
    {
        ...
        return view('banner.edit', compact( 'detail', 'detailBanner', 'object_id', 'object_type'));
    }
