...
class LoaiThuocTinhController extends Controller
{
    ...
    */
    ...
    {   
        ...
        return view('loai-thuoc-tinh.index', compact( 'items', 'loaiSp', 'loai_id' ));
    }
    ...
    */
    ...
    {   
        ...
        return view('loai-thuoc-tinh.create', compact('loaiSp', 'loai_id'));
    }
    ...
    public function getLoaiThuocTinhByLoaiId(Request $request){
        ...
        return view('loai-thuoc-tinh.ajax-get-thuoc-tinh', compact('loaiThuocTinh'));
    }
    /**
    ...
    */
    public function edit($id)
    {
        ...
        return view('loai-thuoc-tinh.edit', compact( 'detail', 'loaiSp'));
    }
