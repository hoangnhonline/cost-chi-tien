...
class ArticlesController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('articles.index', compact( 'items', 'cateArr' , 'title', 'cate_id' ));
    }
    ...
    */
    public function create(Request $request)
    {
        ...
        return view('articles.create', compact( 'tagArr', 'cateArr', 'cate_id'));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('articles.edit', compact('tagArr', 'tagSelected', 'detail', 'cateArr' ));
    }
