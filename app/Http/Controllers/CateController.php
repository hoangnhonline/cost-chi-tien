...
class CateController extends Controller
{
    ...
    */
    ...
    {        
        ...
        return view('cate.index', compact( 'items', 'loaiSp' , 'loai_id', 'loaiSpArr'));
    }
    ...
    */
    public function create(Request $request)
    {
        ...
        return view('cate.create', compact( 'loai_id', 'loaiSpArr'));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('cate.edit', compact( 'detail', 'loaiSpArr', 'meta', 'loaiSp'));
    }
