...
class ThuocTinhController extends Controller
{
    ...
    */
    ...
    {   
        ...
        */
        ...
        return view('thuoc-tinh.index', compact( 'items', 'loaiSp', 'loai_thuoc_tinh_id', 'loai_id', 'loaiThuocTinh'));
    }
    ...
    */
    ...
    {           
        ...
        return view('thuoc-tinh.create', compact('loaiSp', 'loaiThuocTinh', 'loai_thuoc_tinh_id', 'loai_id'));
    }
    ...
    */
    public function edit($id)
    {
        ...
        return view('thuoc-tinh.edit', compact( 'detail', 'loaiSp', 'loaiThuocTinh'));
    }
