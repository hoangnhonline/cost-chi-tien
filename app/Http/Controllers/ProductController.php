...
class ProductController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('product.index', compact( 'items', 'arrSearch', 'loaiSpArr', 'cateArr'));
    }
    public function short(Request $request)
    {
        ...
        return view('product.short', compact( 'items', 'arrSearch', 'loaiSpArr', 'cateArr'));
    }
    public function spTuongThich(Request $request){
        ...
        return view('product.tuong-thich', compact( 'detail', 'loaiSpArr', 'cateArr', 'spSelected', 'productArr', 'str_sp_bo_mach_chinh','str_sp_bo_vi_xu_ly', 'str_sp_card_man_hinh', 'str_sp_bo_nho', 'str_sp_case', 'str_sp_nguon'));   
    }
    public function ajaxSearch(Request $request){    
        ...
        return view('product.content-search', compact( 'items', 'arrSearch', 'loaiSpArr', 'cateArr', 'search_type'));
    }
    ...
    public function ajaxSearchTuongThich(Request $request){    
        ...
        return view('product.tuong-thich.content-search-tuong-thich', compact( 'items', 'arrSearch', 'loaiSpArr', 'cateArr', 'search_type', 'cate_id'));
    }
    /**
    ...
    */
    public function create(Request $request)
    {
        ...
        $colorArr = Color::all();
        $mucDichArr = [];
        return view('product.create', compact('loaiSpArr', 'cateArr', 'colorArr', 'loai_id', 'thuocTinhArr', 'cate_id', 'mucDichArr'));
    }
    ...
    */
    ...
    public function ajaxSaveRelated(Request $request){
        ...
        return view('product.save-related', compact('dataArr' , 'type'));
    ...
    public function ajaxSaveTuongThich(Request $request){
        ...
        return view('product.tuong-thich.save-tuong-thich', compact('dataArr' , 'cate_id'));
    ...
    */
    public function edit($id)
    {
        ...
        $colorArr = Color::all();        
        return view('product.edit', compact( 'detail', 'hinhArr', 'thuocTinhArr', 'spThuocTinhArr', 'colorArr', 'loaiSpArr', 'cateArr', 'meta', 'phuKienArr', 'tuongTuArr', 'soSanhArr'));
    }
    public function ajaxDetail(Request $request)
    {       
        $id = $request->id;
        $detail = SanPham::find($id);
        return view('product.ajax-detail', compact( 'detail' ));
    }
    /**
