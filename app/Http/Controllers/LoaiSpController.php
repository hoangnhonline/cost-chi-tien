...
class LoaiSpController extends Controller
{
    ...
    */
    public function index(Request $request)
    {
        ...
        return view('loai-sp.index', compact( 'items' ));
    }
    ...
    */
    ...
    public function thuocTinh(Request $request){      
        ...
        return view('loai-sp.thuoc-tinh', compact( 'detailLoai', 'loai_id', 'thuocTinhArr', 'thuocTinhArr'));
    }
    ...
    public function editThuocTinh(Request $request){      
        ...
        return view('loai-sp.edit-thuoc-tinh', compact( 'detailLoai', 'loai_id', 'thuocTinhArr', 'thuocTinhArr', 'arrSelected', 'detail'));
    }
    ...
    public function listThuocTinh( Request $request){
        ...
        return view('loai-sp.list-thuoc-tinh', compact('detail', 'detailLoai', 'items', 'thuoctinh'));
    ...
    */
    public function edit($id)
    {
        ...
        return view('loai-sp.edit', compact( 'detail', 'meta'));
    }
